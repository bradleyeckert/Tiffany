...
add wave -noupdate -color Orange -radix hexadecimal /m32_tb/cpu/CARRY
...
add wave -noupdate -color {Spring Green} -radix hexadecimal /m32_tb/cpu/RAM_we
...
WaveRestoreCursors {{Cursor 1} {93546790 ps} 0}
...
update
WaveRestoreZoom {93228838 ps} {94509710 ps}
