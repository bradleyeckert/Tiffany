...
ALIGN							\ MUST ALIGN HERE AFTER THE AU TEST
...
T{ : GD6  ( PAT: T{0 0},{0 0}{1 0}{1 1},{0 0}{1 0}{1 1}{2 0}{2 1}{2 2}T )
   0 SWAP 0 DO
...
T{ 1 1 DNEGATE 2 ' SM/REM CATCH 0= -> -1 MAX-INT INVERT TRUE }T
T{ 1 1 -2 ' SM/REM CATCH 0= -> 1 MAX-INT INVERT TRUE }T
T{ MAX-UINT MAX-INT 2/ MAX-INT INVERT ' FM/MOD CATCH -> -1 MAX-INT INVERT 0 }T
T{ MAX-UINT MAX-INT 2/ MAX-INT INVERT ' SM/REM CATCH -> MAX-INT MAX-INT NEGATE 0 }T
T{ 0 MAX-INT 2/ 1+ MAX-INT INVERT ' FM/MOD CATCH -> 0 MAX-INT INVERT 0 }T
T{ 0 MAX-INT 2/ 1+ MAX-INT INVERT ' SM/REM CATCH -> 0 MAX-INT INVERT 0 }T
T{ 1 MAX-INT 2/ 1+ MAX-INT INVERT ' SM/REM CATCH 0= -> 1 MAX-INT INVERT TRUE }T
T{ 0 MAX-UINT -1 S>D D+ MAX-UINT ' UM/MOD CATCH 0= -> MAX-UINT 1- MAX-UINT TRUE }T
